...
Vaultwise/ ├── app/ │ └── src/ │ └── main/ │ ├── java/com/vaultwise/ # Source code for the application │ ├── res/ # Layouts, drawables, strings, styles, etc. │ └── AndroidManifest.xml # App manifest │ └── build.gradle # App-specific Gradle script ├── build.gradle # Global build configurations └── settings.gradle # Module definitions
